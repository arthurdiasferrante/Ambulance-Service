...
class AmbulanciaAtendimentoTest {

    @Test
    void cenarioGrafoBairrosHospitalMaisProximoComLeito() {
        ...
        for (int i = 0; i < bairrosTeste.length; i++) {
            assertEquals(esperados[i], atendimento.encontrarHospital(bairrosTeste[i]), "bairro " + bairrosTeste[i]);
        }
    }
}
